...
class ScrapeMapper:
    ...
    async def xxembed(self) -> None:
        """Create a XXembed crawler instance"""
        from cyberdrop_dl.scraper.crawlers.xxembed_crawler import XXEmbedCrawler
        self.existing_crawlers['xxembed'] = XXEmbedCrawler(self.manager)
