...
class XXEmbedCrawler(Crawler):
    ...
    async def video(self, scrape_item: ScrapeItem) -> None:
        async with self.request_limiter:
            ...
            download_dir = self.get_save_path("video", file_name)
    ...
    def move_file(self, file_name: str, download_dir):
    ...
    def get_save_path(self, type: str, name: str):
        ...
        if type == "video":
            ...
            return os.path.join(
                os.getcwd(), default_download_path, "Loose_files_xxembed", name
            )
